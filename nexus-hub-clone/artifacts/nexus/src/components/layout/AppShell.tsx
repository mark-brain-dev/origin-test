...
function SimpleView({ title, emoji }: { title: string; emoji: string }) {
  return (
...
export default function AppShell() {
  ...
  function renderContent() {
    ...
    if (activeView === "library") return <SimpleView title="Library" emoji="📚" />;
    if (activeView === "tasks") return <SimpleView title="My Tasks" emoji="✅" />;
    if (activeView === "trash") return <SimpleView title="Trash" emoji="🗑️" />;
    if (activeView === "meetings") return <SimpleView title="Meetings" emoji="📅" />;
    if (activeView === "connections") return <SimpleView title="Connections" emoji="🔗" />;
